/**
 * TITAN RADIO — user-built WEB-band radio stations.
 * Manual OTP registration is verified via kobi@media-deal.co.il.
 * All persistence is local (localStorage); no server dependency.
 *
 * Extracted from public/index.html so the shell stays inline-script free
 * (gated by src/__tests__/smoke.test.ts).
 */
(function(){
